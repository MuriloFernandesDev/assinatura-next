...
<div className="mx-auto max-w-5xl relative px-4 py-6 flex">
<Image src={FogueteImg} className="flex max-w-md" alt="" />
...
<p>Nosso Plano Premium possibilita uma experiência completa de match com TAXA ZERO. Você só precisa fazer alguns cliques do seu computador que nós cuidamos de tudo!</p>
...
<>
<div className="mx-auto max-w-5xl relative px-4 py-6 flex flex-col lg:flex-row xl:flex-row items-center justify-around">
 <div className="text-white flex flex-col justify-center items-center">
   <Image src={CartaoImg} className="w-64 mt-12" alt="" />
    <span className="text-lg text-center mt-6">Aumente seus lucros com o cartão de crédito.</span>
 </div>
 <div className="text-white flex flex-col justify-center items-center">
   <Image src={CelularImg} className='w-64' alt=""/>
   <span className="text-lg text-center mt-6 sm: pb-5">Receba o dinheiro de suas vendas em 30 dias.</span>
</div>
<div className="text-white flex flex-col justify-center items-center">
   <Image src={SacolaImg} className='w-64 mt-12' alt=""/>
   <span className="text-lg text-center mt-6">O produto é enviado para o cliente com segurança.</span>
</div>
</div>            
</>

<div className="mx-auto max-w-5xl relative px-4 pb-12">
  <h1 className="text-center text-5xl text-green-0300 font-bold leading-none mt-32">Vantagens de ser Premium</h1>
